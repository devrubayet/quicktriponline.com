...
class AirlinesList(models.Model):
    airlines_name = models.CharField(max_length=100,blank=True, null=True,unique=True)
    image = models.ImageField(upload_to='airlines_images/')  # Directory for storing images
